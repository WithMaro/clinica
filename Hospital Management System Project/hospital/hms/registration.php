	...
	<body class="login">
		...
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../index.html"><h2>Registro</h2></a>
				</div>
				<!-- start: REGISTER BOX -->
				<div class="box-register">
					<form name="registration" id="registration"  method="post" onSubmit="return valid();">
						<fieldset>
							...
							<div class="form-group">
								<input type="text" class="form-control" name="full_name" placeholder="Nombres Completos" required>
							</div>
							<div class="form-group">
								<input type="text" class="form-control" name="address" placeholder="Correo Electrónico" required>
							</div>
							<div class="form-group">
					...
					<div class="copyright">
						&copy; <span class="current-year"></span><span class="text-bold text-uppercase"> </span>. <span>Todos los derechos Reservados</span>
					</div>
