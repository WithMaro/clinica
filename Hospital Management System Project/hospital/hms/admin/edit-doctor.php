...
<html lang="en">
	<head>
		<title>Administración | Editar Detalles del Doctor</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Administración | Editar Detalles del Doctor</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Editar información del Doctor</h5>
												</div>
...
<div class="form-group">
															<label for="address">
																 Dirección de a clinica del doctor
															</label>
