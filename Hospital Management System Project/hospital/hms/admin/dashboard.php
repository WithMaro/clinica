...
<html lang="en">
	<head>
		<title>Administración  | Tablero</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Administración | Tablero</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
...
{
?>
											Total de Doctores:<?php echo htmlentities($num_rows1);  } ?>		
												</a>
...
{
?>
											Total de equipos :<?php echo htmlentities($num_rows2);  } ?>	
												</a>
												</a>
											</p>
										</div>
