...
<html lang="en">
	<head>
		<title>Administración | Cambiar Contraseña</title>
		<meta charset="utf-8" />
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Administración | Cambiar Contraseña</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
...
<div class="form-group">
									...
									<input type="password" name="cfpass" class="form-control"  placeholder="Confirma Contraseña">
														</div>
